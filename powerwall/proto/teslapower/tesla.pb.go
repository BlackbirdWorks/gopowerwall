...
//
// Create tesla_pb2.py for use in projects using the protoc compiler:
...
func (x *DeviceVital) GetValue() isDeviceVital_Value {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *DeviceVital) GetIntValue() int64 {
	if x != nil {
		if x, ok := x.Value.(*DeviceVital_IntValue); ok {
			return x.IntValue
		}
	}
	return 0
...
func (x *DeviceVital) GetFloatValue() float64 {
	if x != nil {
		if x, ok := x.Value.(*DeviceVital_FloatValue); ok {
			return x.FloatValue
		}
	}
	return 0
...
func (x *DeviceVital) GetStringValue() string {
	if x != nil {
		if x, ok := x.Value.(*DeviceVital_StringValue); ok {
...
func (x *DeviceVital) GetBoolValue() bool {
	if x != nil {
		if x, ok := x.Value.(*DeviceVital_BoolValue); ok {
			return x.BoolValue
		}
	}
	return false
...
type DeviceAttributes struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to DeviceAttributes:
	//
...
func (x *DeviceAttributes) GetDeviceAttributes() isDeviceAttributes_DeviceAttributes {
	if x != nil {
...
func (x *DeviceAttributes) GetTeslaEnergyEcuAttributes() *TeslaEnergyEcuAttributes {
	if x != nil {
		if x, ok := x.DeviceAttributes.(*DeviceAttributes_TeslaEnergyEcuAttributes); ok {
...
func (x *DeviceAttributes) GetGeneratorAttributes() *GeneratorAttributes {
	if x != nil {
		if x, ok := x.DeviceAttributes.(*DeviceAttributes_GeneratorAttributes); ok {
...
func (x *DeviceAttributes) GetPvInverterAttributes() *PVInverterAttributes {
	if x != nil {
		if x, ok := x.DeviceAttributes.(*DeviceAttributes_PvInverterAttributes); ok {
			return x.PvInverterAttributes
		}
	}
	return nil
...
func (x *DeviceAttributes) GetMeterAttributes() *MeterAttributes {
	if x != nil {
		if x, ok := x.DeviceAttributes.(*DeviceAttributes_MeterAttributes); ok {
			return x.MeterAttributes
		}
	}
	return nil
...
func (x *TEGMessages) GetGetConfigRequest() *TEGAPIGetConfigRequest {
	if x != nil {
		if x, ok := x.Message.(*TEGMessages_GetConfigRequest); ok {
...
func (x *TEGMessages) GetGetConfigResponse() *TEGAPIGetConfigResponse {
	if x != nil {
		if x, ok := x.Message.(*TEGMessages_GetConfigResponse); ok {
...
func (x *TEGMessages) GetSetIslandModeRequest() *TEGAPISetIslandModeRequest {
	if x != nil {
		if x, ok := x.Message.(*TEGMessages_SetIslandModeRequest); ok {
...
func (x *TEGMessages) GetSetIslandModeResponse() *TEGAPISetIslandModeResponse {
	if x != nil {
		if x, ok := x.Message.(*TEGMessages_SetIslandModeResponse); ok {
...
func (x *TEGMessages) GetTriggerIslandingBlackStartRequest() *TEGAPITriggerIslandingBlackStartRequest {
	if x != nil {
		if x, ok := x.Message.(*TEGMessages_TriggerIslandingBlackStartRequest); ok {
...
func (x *TEGMessages) GetTriggerIslandingBlackStartResponse() *TEGAPITriggerIslandingBlackStartResponse {
	if x != nil {
		if x, ok := x.Message.(*TEGMessages_TriggerIslandingBlackStartResponse); ok {
...
func (x *TEGMessages) GetTriggerAssetManifestUploadRequest() *TEGAPITriggerAssetManifestUploadRequest {
	if x != nil {
		if x, ok := x.Message.(*TEGMessages_TriggerAssetManifestUploadRequest); ok {
...
func (x *TEGMessages) GetTriggerAssetManifestUploadResponse() *TEGAPITriggerAssetManifestUploadResponse {
	if x != nil {
		if x, ok := x.Message.(*TEGMessages_TriggerAssetManifestUploadResponse); ok {
...
const file_tesla_proto_rawDesc = "" +
	"\n" +
	"\vtesla.proto\x12\n" +
	"teslapower\x1a\x19google/protobuf/any.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"@\n" +
	"\fExternalAuth\x120\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1c.teslapower.ExternalAuthTypeR\x04type\"\x93\x01\n" +
	...
	"partNumber\x12\"\n" +
	"\fserialNumber\x18\x02 \x01(\tR\fserialNumber\"\x1b\n" +
	"\x03Din\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value\"E\n" +
	"\x0fFirmwareVersion\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12\x18\n" +
	"\agithash\x18\x02 \x01(\tR\agithash\"\x9f\x01\n" +
	"\x11AccumulatedEnergy\x12\x1a\n" +
	"\benergyWh\x18\x01 \x01(\x02R\benergyWh\x12*\n" +
	"\x10accumulationType\x18\x02 \x01(\x05R\x10accumulationType\x126\n" +
	"\aperiodS\x18\x03 \x01(\v2\x17.teslapower.UInt64ValueH\x00R\aperiodS\x88\x01\x01B\n" +
	"\n" +
	"\b_periodS\"\xab\x03\n" +
	"\x11InstACMeasurement\x12 \n" +
	"\vvoltageVrms\x18\x01 \x01(\x02R\vvoltageVrms\x12 \n" +
	"\vfrequencyHz\x18\x02 \x01(\x02R\vfrequencyHz\x12=\n" +
	"\vcurrentArms\x18\x03 \x01(\v2\x16.teslapower.FloatValueH\x00R\vcurrentArms\x88\x01\x01\x12;\n" +
	"\n" +
	"realPowerW\x18\x04 \x01(\v2\x16.teslapower.FloatValueH\x01R\n" +
	"realPowerW\x88\x01\x01\x12G\n" +
	"\x10reactivePowerVar\x18\x05 \x01(\v2\x16.teslapower.FloatValueH\x02R\x10reactivePowerVar\x88\x01\x01\x12E\n" +
	"\x0fapparentPowerVa\x18\x06 \x01(\v2\x16.teslapower.FloatValueH\x03R\x0fapparentPowerVa\x88\x01\x01B\x0e\n" +
	"\f_currentArmsB\r\n" +
	"\v_realPowerWB\x13\n" +
	"\x11_reactivePowerVarB\x12\n" +
	"\x10_apparentPowerVa\"u\n" +
	"\x11InstDCMeasurement\x12\x1a\n" +
	"\bvoltageV\x18\x01 \x01(\x02R\bvoltageV\x127\n" +
	"\bcurrentA\x18\x02 \x01(\v2\x16.teslapower.FloatValueH\x00R\bcurrentA\x88\x01\x01B\v\n" +
	"\t_currentA\"\xab\x01\n" +
	"\x14GridComplianceStatus\x12\x1c\n" +
	"\tgridState\x18\x01 \x01(\x05R\tgridState\x12X\n" +
	"\x18qualifyingTimeRemainingS\x18\x02 \x01(\v2\x17.teslapower.UInt32ValueH\x00R\x18qualifyingTimeRemainingS\x88\x01\x01B\x1b\n" +
	"\x19_qualifyingTimeRemainingS\"\xaa\x01\n" +
	...
	"\x03dns\x18\x06 \x03(\aR\x03dnsJ\x04\b\x01\x10\x02\"\x8a\x01\n" +
	"\x04Rssi\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x11R\x05value\x12R\n" +
	"\x15signalStrengthPercent\x18\x02 \x01(\v2\x17.teslapower.UInt32ValueH\x00R\x15signalStrengthPercent\x88\x01\x01B\x18\n" +
	"\x16_signalStrengthPercent\"\x8a\x02\n" +
	...
	"\x0econnectedTesla\x18\x03 \x01(\bR\x0econnectedTesla\x12)\n" +
	"\x04rssi\x18\x04 \x01(\v2\x10.teslapower.RssiH\x00R\x04rssi\x88\x01\x01\x12-\n" +
	"\x03snr\x18\x05 \x01(\v2\x16.teslapower.Int32ValueH\x01R\x03snr\x88\x01\x01B\a\n" +
	"\x05_rssiB\x06\n" +
	"\x04_snr\"\xbd\x02\n" +
	...
	"\vactiveRoute\x18\x03 \x01(\bR\vactiveRoute\x12K\n" +
	"\n" +
	"ipv4Config\x18\x04 \x01(\v2&.teslapower.NetworkInterfaceIPv4ConfigH\x00R\n" +
	"ipv4Config\x88\x01\x01\x12Z\n" +
	"\x12connectivityStatus\x18\x05 \x01(\v2%.teslapower.NetworkConnectivityStatusH\x01R\x12connectivityStatus\x88\x01\x01B\r\n" +
	"\v_ipv4ConfigB\x15\n" +
	"\x13_connectivityStatus\"$\n" +
	"\fWifiPassword\x12\x14\n" +
	"\x05value\x18\x01 \x01(\tR\x05value\"J\n" +
	"\x10EncryptedMessage\x12\x16\n" +
	"\x06cipher\x18\x01 \x01(\x05R\x06cipher\x12\x1e\n" +
	"\n" +
	...
	"\fsecurityType\x18\x03 \x01(\x05H\x01R\fsecurityType\x88\x01\x01B\v\n" +
	"\t_passwordB\x0f\n" +
	"\r_securityType\"\xad\x01\n" +
	"\vWifiNetwork\x12\x12\n" +
	"\x04ssid\x18\x01 \x01(\tR\x04ssid\x12\x1c\n" +
	"\trssiValue\x18\x02 \x01(\x11R\trssiValue\x12)\n" +
	"\x04rssi\x18\x03 \x01(\v2\x10.teslapower.RssiH\x00R\x04rssi\x88\x01\x01\x12'\n" +
	"\fsecurityType\x18\x04 \x01(\x05H\x01R\fsecurityType\x88\x01\x01B\a\n" +
	"\x05_rssiB\x0f\n" +
	"\r_securityType\"\xa8\x03\n" +
	"\fSystemUpdate\x12(\n" +
	"\x0fhandshakeResult\x18\x01 \x01(\x05R\x0fhandshakeResult\x12\"\n" +
	"\fupdateStatus\x18\x02 \x01(\x05R\fupdateStatus\x12R\n" +
	"\x13serverStagedVersion\x18\x03 \x01(\v2\x1b.teslapower.FirmwareVersionH\x00R\x13serverStagedVersion\x88\x01\x01\x12\x1e\n" +
	"\n" +
	...
	"\x10lastUpdateResult\x18\b \x01(\rR\x10lastUpdateResultB\x16\n" +
	"\x14_serverStagedVersion\"K\n" +
	"\rErrorResponse\x12/\n" +
	"\x06status\x18\x01 \x01(\v2\x12.teslapower.StatusH\x00R\x06status\x88\x01\x01B\t\n" +
	"\a_status\"\x1f\n" +
	"\x1dCommonAPIGetSystemInfoRequest\"\xad\x02\n" +
	"\x1eCommonAPIGetSystemInfoResponse\x122\n" +
	"\bdeviceId\x18\x01 \x01(\v2\x11.teslapower.EcuIdH\x00R\bdeviceId\x88\x01\x01\x12\x10\n" +
	"\x03din\x18\x02 \x01(\tR\x03din\x12J\n" +
	"\x0ffirmwareVersion\x18\x03 \x01(\v2\x1b.teslapower.FirmwareVersionH\x01R\x0ffirmwareVersion\x88\x01\x01\x12A\n" +
	"\fsystemUpdate\x18\x05 \x01(\v2\x18.teslapower.SystemUpdateH\x02R\fsystemUpdate\x88\x01\x01B\v\n" +
	"\t_deviceIdB\x12\n" +
	"\x10_firmwareVersionB\x0f\n" +
	"\r_systemUpdateJ\x04\b\x04\x10\x05\"$\n" +
	...
	"#CommonAPIGetNetworkingStatusRequest\"\xac\x02\n" +
	"$CommonAPIGetNetworkingStatusResponse\x12;\n" +
	"\n" +
	"wifiConfig\x18\x01 \x01(\v2\x16.teslapower.WifiConfigH\x00R\n" +
	"wifiConfig\x88\x01\x01\x125\n" +
	"\x04wifi\x18\x02 \x01(\v2\x1c.teslapower.NetworkInterfaceH\x01R\x04wifi\x88\x01\x01\x123\n" +
	"\x03eth\x18\x03 \x01(\v2\x1c.teslapower.NetworkInterfaceH\x02R\x03eth\x88\x01\x01\x123\n" +
	"\x03gsm\x18\x04 \x01(\v2\x1c.teslapower.NetworkInterfaceH\x03R\x03gsm\x88\x01\x01B\r\n" +
	"\v_wifiConfigB\a\n" +
	"\x05_wifiB\x06\n" +
	"\x04_ethB\x06\n" +
	"\x04_gsm\"\xa4\x01\n" +
	"\x18CommonAPIWifiScanRequest\x12*\n" +
	"\x10maxScanDurationS\x18\x01 \x01(\rR\x10maxScanDurationS\x122\n" +
	"\x14desiredSecurityTypes\x18\x02 \x03(\x05R\x14desiredSecurityTypes\x12(\n" +
	"\x0fmaximumTotalAps\x18\x03 \x01(\rR\x0fmaximumTotalAps\"X\n" +
	"\x19CommonAPIWifiScanResponse\x12;\n" +
	"\fwifiNetworks\x18\x01 \x03(\v2\x17.teslapower.WifiNetworkR\fwifiNetworks\"\x85\x01\n" +
	"\x1dCommonAPIConfigureWifiRequest\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12;\n" +
	"\n" +
	"wifiConfig\x18\x02 \x01(\v2\x16.teslapower.WifiConfigH\x00R\n" +
	"wifiConfig\x88\x01\x01B\r\n" +
	"\v_wifiConfig\"\xac\x01\n" +
	"\x1eCommonAPIConfigureWifiResponse\x12;\n" +
	"\n" +
	"wifiConfig\x18\x01 \x01(\v2\x16.teslapower.WifiConfigH\x00R\n" +
	"wifiConfig\x88\x01\x01\x125\n" +
	"\x04wifi\x18\x02 \x01(\v2\x1c.teslapower.NetworkInterfaceH\x01R\x04wifi\x88\x01\x01B\r\n" +
	"\v_wifiConfigB\a\n" +
	"\x05_wifi\"\x81\x02\n" +
	...
	"\n" +
	"wifiConfig\x18\x02 \x01(\v2\x16.teslapower.WifiConfigH\x00R\n" +
	"wifiConfig\x88\x01\x01\x12O\n" +
	"\x11encryptedPassword\x18\x03 \x01(\v2\x1c.teslapower.EncryptedMessageH\x01R\x11encryptedPassword\x88\x01\x01B\r\n" +
	"\v_wifiConfigB\x14\n" +
	"\x12_encryptedPassword\"\xd9\x01\n" +
	"3CommonAPIConfigureWifiWithEncryptedPasswordResponse\x12;\n" +
	"\n" +
	"wifiConfig\x18\x01 \x01(\v2\x16.teslapower.WifiConfigH\x00R\n" +
	"wifiConfig\x88\x01\x01\x125\n" +
	"\x04wifi\x18\x02 \x01(\v2\x1c.teslapower.NetworkInterfaceH\x01R\x04wifi\x88\x01\x01\x12\x16\n" +
	"\x06result\x18\x03 \x01(\x05R\x06resultB\r\n" +
	"\v_wifiConfigB\a\n" +
	"\x05_wifi\"\x1c\n" +
	"\x1aCommonAPIDeviceCertRequest\"U\n" +
	"\x1bCommonAPIDeviceCertResponse\x12\x16\n" +
	"\x06format\x18\x01 \x01(\x05R\x06format\x12\x1e\n" +
	"\n" +
	"deviceCert\x18\x02 \x01(\fR\n" +
	"deviceCert\"\x1e\n" +
	"\bAlertLog\x12\x12\n" +
	"\x04data\x18\x01 \x01(\x06R\x04data\"!\n" +
	"\vAlertMatrix\x12\x12\n" +
	"\x04data\x18\x01 \x01(\x06R\x04data\"\x97\x01\n" +
	"\x13EnergySiteNetDevice\x12&\n" +
	"\x03din\x18\x01 \x01(\v2\x0f.teslapower.DinH\x00R\x03din\x88\x01\x01\x12?\n" +
	"\fwifiApConfig\x18\x02 \x01(\v2\x16.teslapower.WifiConfigH\x01R\fwifiApConfig\x88\x01\x01B\x06\n" +
	"\x04_dinB\x0f\n" +
	"\r_wifiApConfig\"j\n" +
	" EnergySiteNetRecentlyAddedDevice\x12&\n" +
	"\x03din\x18\x01 \x01(\v2\x0f.teslapower.DinH\x00R\x03din\x88\x01\x01\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x05R\x06statusB\x06\n" +
	"\x04_din\"l\n" +
	"\"EnergySiteNetRecentlyRemovedDevice\x12&\n" +
	"\x03din\x18\x01 \x01(\v2\x0f.teslapower.DinH\x00R\x03din\x88\x01\x01\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x05R\x06statusB\x06\n" +
	"\x04_din\"\xfe\x01\n" +
	"\x13EnergySiteNetConfig\x129\n" +
	"\adevices\x18\x01 \x03(\v2\x1f.teslapower.EnergySiteNetDeviceR\adevices\x12R\n" +
	"\rrecentlyAdded\x18\x02 \x03(\v2,.teslapower.EnergySiteNetRecentlyAddedDeviceR\rrecentlyAdded\x12X\n" +
	"\x0frecentlyRemoved\x18\x03 \x03(\v2..teslapower.EnergySiteNetRecentlyRemovedDeviceR\x0frecentlyRemoved\"[\n" +
	" EnergySiteNetAPIAddDeviceRequest\x127\n" +
	"\x06device\x18\x01 \x01(\v2\x1f.teslapower.EnergySiteNetDeviceR\x06device\"w\n" +
	"!EnergySiteNetAPIAddDeviceResponse\x12R\n" +
	"\rrecentlyAdded\x18\x01 \x01(\v2,.teslapower.EnergySiteNetRecentlyAddedDeviceR\rrecentlyAdded\"H\n" +
	"#EnergySiteNetAPIRemoveDeviceRequest\x12!\n" +
	"\x03din\x18\x01 \x01(\v2\x0f.teslapower.DinR\x03din\"\x80\x01\n" +
	"$EnergySiteNetAPIRemoveDeviceResponse\x12X\n" +
	"\x0frecentlyRemoved\x18\x01 \x01(\v2..teslapower.EnergySiteNetRecentlyRemovedDeviceR\x0frecentlyRemoved\"\"\n" +
	" EnergySiteNetAPIGetConfigRequest\"\\\n" +
	"!EnergySiteNetAPIGetConfigResponse\x127\n" +
	"\x06config\x18\x01 \x01(\v2\x1f.teslapower.EnergySiteNetConfigR\x06config\"\xbc\x01\n" +
	"\vDeviceVital\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tH\x01R\x04name\x88\x01\x01\x12\x1c\n" +
	"\bintValue\x18\x03 \x01(\x03H\x00R\bintValue\x12 \n" +
	"\n" +
	"floatValue\x18\x04 \x01(\x01H\x00R\n" +
	"floatValue\x12\"\n" +
	"\vstringValue\x18\x05 \x01(\tH\x00R\vstringValue\x12\x1e\n" +
	"\tboolValue\x18\x06 \x01(\bH\x00R\tboolValueB\a\n" +
	"\x05valueB\a\n" +
	"\x05_name\"#\n" +
	...
	"\n" +
	"FloatValue\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x02R\x05value\"\x8f\x02\n" +
	"\x14ConnectionParameters\x12:\n" +
	"\tipAddress\x18\x01 \x01(\v2\x17.teslapower.StringValueH\x00R\tipAddress\x88\x01\x01\x12<\n" +
	"\n" +
	"serialPort\x18\x02 \x01(\v2\x17.teslapower.StringValueH\x01R\n" +
	"serialPort\x88\x01\x01\x12#\n" +
	"\n" +
	"serialBaud\x18\x03 \x01(\x03H\x02R\n" +
	"serialBaud\x88\x01\x01\x12\x1f\n" +
	"\bmodbusId\x18\x04 \x01(\rH\x03R\bmodbusId\x88\x01\x01B\f\n" +
	"\n" +
	"_ipAddressB\r\n" +
	"\v_serialPortB\r\n" +
	"\v_serialBaudB\v\n" +
	"\t_modbusId\"\xe3\x01\n" +
	"\x0fTeslaHardwareId\x124\n" +
	"\x06pcbaId\x18\x01 \x01(\v2\x17.teslapower.UInt32ValueH\x00R\x06pcbaId\x88\x01\x01\x12<\n" +
	"\n" +
	"assemblyId\x18\x02 \x01(\v2\x17.teslapower.UInt32ValueH\x01R\n" +
	"assemblyId\x88\x01\x01\x126\n" +
	"\ausageId\x18\x03 \x01(\v2\x17.teslapower.UInt32ValueH\x02R\ausageId\x88\x01\x01B\t\n" +
	"\a_pcbaIdB\r\n" +
	"\v_assemblyIdB\n" +
	"\n" +
	"\b_usageId\"\xd9\x02\n" +
	"\x18TeslaEnergyEcuAttributes\x12\x18\n" +
	"\aecuType\x18\x01 \x01(\x05R\aecuType\x12@\n" +
	"\n" +
	"hardwareId\x18\x02 \x01(\v2\x1b.teslapower.TeslaHardwareIdH\x00R\n" +
	"hardwareId\x88\x01\x01\x12Y\n" +
	"\x14pvInverterAttributes\x18\x03 \x01(\v2 .teslapower.PVInverterAttributesH\x01R\x14pvInverterAttributes\x88\x01\x01\x12J\n" +
	"\x0fmeterAttributes\x18\x04 \x01(\v2\x1b.teslapower.MeterAttributesH\x02R\x0fmeterAttributes\x88\x01\x01B\r\n" +
	"\v_hardwareIdB\x17\n" +
	"\x15_pvInverterAttributesB\x12\n" +
	"\x10_meterAttributes\"\x83\x01\n" +
	"\x13GeneratorAttributes\x120\n" +
	"\x13nameplateRealPowerW\x18\x01 \x01(\x04R\x13nameplateRealPowerW\x12:\n" +
	"\x18nameplateApparentPowerVa\x18\x02 \x01(\x04R\x18nameplateApparentPowerVa\"H\n" +
	"\x14PVInverterAttributes\x120\n" +
	"\x13nameplateRealPowerW\x18\x01 \x01(\x04R\x13nameplateRealPowerW\"7\n" +
	"\x0fMeterAttributes\x12$\n" +
	"\rmeterLocation\x18\x01 \x03(\rR\rmeterLocation\"\x80\x03\n" +
	"\x10DeviceAttributes\x12b\n" +
	"\x18teslaEnergyEcuAttributes\x18\x01 \x01(\v2$.teslapower.TeslaEnergyEcuAttributesH\x00R\x18teslaEnergyEcuAttributes\x12S\n" +
	"\x13generatorAttributes\x18\x02 \x01(\v2\x1f.teslapower.GeneratorAttributesH\x00R\x13generatorAttributes\x12V\n" +
	"\x14pvInverterAttributes\x18\x03 \x01(\v2 .teslapower.PVInverterAttributesH\x00R\x14pvInverterAttributes\x12G\n" +
	"\x0fmeterAttributes\x18\x04 \x01(\v2\x1b.teslapower.MeterAttributesH\x00R\x0fmeterAttributesB\x12\n" +
	"\x10deviceAttributes\"\xfb\a\n" +
	"\x06Device\x12.\n" +
	"\x03din\x18\x01 \x01(\v2\x17.teslapower.StringValueH\x00R\x03din\x88\x01\x01\x12<\n" +
	"\n" +
	"partNumber\x18\x02 \x01(\v2\x17.teslapower.StringValueH\x01R\n" +
	"partNumber\x88\x01\x01\x12@\n" +
	"\fserialNumber\x18\x03 \x01(\v2\x17.teslapower.StringValueH\x02R\fserialNumber\x88\x01\x01\x12@\n" +
	"\fmanufacturer\x18\x04 \x01(\v2\x17.teslapower.StringValueH\x03R\fmanufacturer\x88\x01\x01\x12:\n" +
	"\tsiteLabel\x18\x05 \x01(\v2\x17.teslapower.StringValueH\x04R\tsiteLabel\x88\x01\x01\x12L\n" +
	"\x12componentParentDin\x18\x06 \x01(\v2\x17.teslapower.StringValueH\x05R\x12componentParentDin\x88\x01\x01\x12F\n" +
	"\x0ffirmwareVersion\x18\a \x01(\v2\x17.teslapower.StringValueH\x06R\x0ffirmwareVersion\x88\x01\x01\x12W\n" +
	"\x16firstCommunicationTime\x18\b \x01(\v2\x1a.google.protobuf.TimestampH\aR\x16firstCommunicationTime\x88\x01\x01\x12U\n" +
	"\x15lastCommunicationTime\x18\t \x01(\v2\x1a.google.protobuf.TimestampH\bR\x15lastCommunicationTime\x88\x01\x01\x12Y\n" +
	"\x14connectionParameters\x18\n" +
	" \x01(\v2 .teslapower.ConnectionParametersH\tR\x14connectionParameters\x88\x01\x01\x12M\n" +
	"\x10deviceAttributes\x18\v \x01(\v2\x1c.teslapower.DeviceAttributesH\n" +
	"R\x10deviceAttributes\x88\x01\x01B\x06\n" +
	"\x04_dinB\r\n" +
	"\v_partNumberB\x0f\n" +
	"\r_serialNumberB\x0f\n" +
	"\r_manufacturerB\f\n" +
	...
	"\x11_deviceAttributes\"[\n" +
	"\x1dSiteControllerConnectedDevice\x12/\n" +
	"\x06device\x18\x01 \x01(\v2\x12.teslapower.DeviceH\x00R\x06device\x88\x01\x01B\t\n" +
	"\a_device\"\xb5\x01\n" +
	"'SiteControllerConnectedDeviceWithVitals\x12A\n" +
	"\x06device\x18\x01 \x01(\v2).teslapower.SiteControllerConnectedDeviceR\x06device\x12/\n" +
	"\x06vitals\x18\x02 \x03(\v2\x17.teslapower.DeviceVitalR\x06vitals\x12\x16\n" +
	"\x06alerts\x18\x03 \x03(\tR\x06alerts\"b\n" +
	"\x11DevicesWithVitals\x12M\n" +
	"\adevices\x18\x01 \x03(\v23.teslapower.SiteControllerConnectedDeviceWithVitalsR\adevices\"\x95\x01\n" +
	"\"SiteControllerConnectedDeviceStore\x12o\n" +
	"\x1dsiteControllerConnectedDevice\x18\x01 \x03(\v2).teslapower.SiteControllerConnectedDeviceR\x1dsiteControllerConnectedDevice\"k\n" +
	"\x19BatterySystemCapabilities\x12(\n" +
	"\x0fnominalEnergyWh\x18\x01 \x01(\x04R\x0fnominalEnergyWh\x12$\n" +
	"\rnominalPowerW\x18\x02 \x01(\x04R\rnominalPowerW\"f\n" +
	"\x06Status\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12.\n" +
	"\adetails\x18\x03 \x03(\v2\x14.google.protobuf.AnyR\adetails\"\xab\x03\n" +
	"\bManifest\x12\x1e\n" +
	"\n" +
	"gatewayDin\x18\x01 \x01(\tR\n" +
	"gatewayDin\x12\x18\n" +
	"\atrigger\x18\x02 \x01(\x05R\atrigger\x12@\n" +
	"\rgeneratedTime\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\rgeneratedTime\x12*\n" +
	"\x06device\x18\x04 \x03(\v2\x12.teslapower.DeviceR\x06device\x12h\n" +
	"\x19batterySystemCapabilities\x18\x05 \x01(\v2%.teslapower.BatterySystemCapabilitiesH\x00R\x19batterySystemCapabilities\x88\x01\x01\x12T\n" +
	"\x16gatewayFirmwareVersion\x18\x06 \x01(\v2\x17.teslapower.StringValueH\x01R\x16gatewayFirmwareVersion\x88\x01\x01B\x1c\n" +
	"\x1a_batterySystemCapabilitiesB\x19\n" +
	"\x17_gatewayFirmwareVersion\"\xdc\x02\n" +
	"\x0fMessageEnvelope\x12(\n" +
	"\x0fdeliveryChannel\x18\x01 \x01(\x05R\x0fdeliveryChannel\x12/\n" +
	"\x06sender\x18\x02 \x01(\v2\x17.teslapower.ParticipantR\x06sender\x125\n" +
	"\trecipient\x18\x03 \x01(\v2\x17.teslapower.ParticipantR\trecipient\x124\n" +
	"\x06common\x18\x04 \x01(\v2\x1a.teslapower.CommonMessagesH\x00R\x06common\x12+\n" +
	"\x03teg\x18\x05 \x01(\v2\x17.teslapower.TEGMessagesH\x00R\x03teg\x12I\n" +
	"\renergysitenet\x18\x06 \x01(\v2!.teslapower.EnergySiteNetMessagesH\x00R\renergysitenetB\t\n" +
	"\apayload\"\xbe\x12\n" +
	"\x0eCommonMessages\x12$\n" +
	"\rerrorResponse\x18\x01 \x01(\x05R\rerrorResponse\x12_\n" +
	"\x14getSystemInfoRequest\x18\x02 \x01(\v2).teslapower.CommonAPIGetSystemInfoRequestH\x00R\x14getSystemInfoRequest\x12b\n" +
	"\x15getSystemInfoResponse\x18\x03 \x01(\v2*.teslapower.CommonAPIGetSystemInfoResponseH\x00R\x15getSystemInfoResponse\x12n\n" +
	"\x19setLocalSiteConfigRequest\x18\x04 \x01(\v2..teslapower.CommonAPISetLocalSiteConfigRequestH\x00R\x19setLocalSiteConfigRequest\x12q\n" +
	"\x1asetLocalSiteConfigResponse\x18\x05 \x01(\v2/.teslapower.CommonAPISetLocalSiteConfigResponseH\x00R\x1asetLocalSiteConfigResponse\x12_\n" +
	"\x14performUpdateRequest\x18\x06 \x01(\v2).teslapower.CommonAPIPerformUpdateRequestH\x00R\x14performUpdateRequest\x12b\n" +
	"\x15performUpdateResponse\x18\a \x01(\v2*.teslapower.CommonAPIPerformUpdateResponseH\x00R\x15performUpdateResponse\x12\\\n" +
	"\x13factoryResetRequest\x18\b \x01(\v2(.teslapower.CommonAPIFactoryResetRequestH\x00R\x13factoryResetRequest\x12_\n" +
	"\x14factoryResetResponse\x18\t \x01(\v2).teslapower.CommonAPIFactoryResetResponseH\x00R\x14factoryResetResponse\x12P\n" +
	"\x0fwifiScanRequest\x18\n" +
	" \x01(\v2$.teslapower.CommonAPIWifiScanRequestH\x00R\x0fwifiScanRequest\x12S\n" +
	"\x10wifiScanResponse\x18\v \x01(\v2%.teslapower.CommonAPIWifiScanResponseH\x00R\x10wifiScanResponse\x12_\n" +
	"\x14configureWifiRequest\x18\f \x01(\v2).teslapower.CommonAPIConfigureWifiRequestH\x00R\x14configureWifiRequest\x12b\n" +
	"\x15configureWifiResponse\x18\r \x01(\v2*.teslapower.CommonAPIConfigureWifiResponseH\x00R\x15configureWifiResponse\x12b\n" +
	"\x15checkForUpdateRequest\x18\x0e \x01(\v2*.teslapower.CommonAPICheckForUpdateRequestH\x00R\x15checkForUpdateRequest\x12e\n" +
	"\x16checkForUpdateResponse\x18\x0f \x01(\v2+.teslapower.CommonAPICheckForUpdateResponseH\x00R\x16checkForUpdateResponse\x12Y\n" +
	"\x12clearUpdateRequest\x18\x10 \x01(\v2'.teslapower.CommonAPIClearUpdateRequestH\x00R\x12clearUpdateRequest\x12\\\n" +
	"\x13clearUpdateResponse\x18\x11 \x01(\v2(.teslapower.CommonAPIClearUpdateResponseH\x00R\x13clearUpdateResponse\x12V\n" +
	"\x11deviceCertRequest\x18\x12 \x01(\v2&.teslapower.CommonAPIDeviceCertRequestH\x00R\x11deviceCertRequest\x12Y\n" +
	"\x12deviceCertResponse\x18\x13 \x01(\v2'.teslapower.CommonAPIDeviceCertResponseH\x00R\x12deviceCertResponse\x12\x9e\x01\n" +
	")configureWifiWithEncryptedPasswordRequest\x18\x14 \x01(\v2>.teslapower.CommonAPIConfigureWifiWithEncryptedPasswordRequestH\x00R)configureWifiWithEncryptedPasswordRequest\x12\xa1\x01\n" +
	"*configureWifiWithEncryptedPasswordResponse\x18\x15 \x01(\v2?.teslapower.CommonAPIConfigureWifiWithEncryptedPasswordResponseH\x00R*configureWifiWithEncryptedPasswordResponse\x12q\n" +
	"\x1agetNetworkingStatusRequest\x18\x16 \x01(\v2/.teslapower.CommonAPIGetNetworkingStatusRequestH\x00R\x1agetNetworkingStatusRequest\x12t\n" +
	"\x1bgetNetworkingStatusResponse\x18\x17 \x01(\v20.teslapower.CommonAPIGetNetworkingStatusResponseH\x00R\x1bgetNetworkingStatusResponseB\t\n" +
	"\amessage\"\x9c\a\n" +
	"\vTEGMessages\x12P\n" +
	"\x10getConfigRequest\x18\x01 \x01(\v2\".teslapower.TEGAPIGetConfigRequestH\x00R\x10getConfigRequest\x12S\n" +
	"\x11getConfigResponse\x18\x02 \x01(\v2#.teslapower.TEGAPIGetConfigResponseH\x00R\x11getConfigResponse\x12\\\n" +
	"\x14setIslandModeRequest\x18\x03 \x01(\v2&.teslapower.TEGAPISetIslandModeRequestH\x00R\x14setIslandModeRequest\x12_\n" +
	"\x15setIslandModeResponse\x18\x04 \x01(\v2'.teslapower.TEGAPISetIslandModeResponseH\x00R\x15setIslandModeResponse\x12\x83\x01\n" +
	"!triggerIslandingBlackStartRequest\x18\x05 \x01(\v23.teslapower.TEGAPITriggerIslandingBlackStartRequestH\x00R!triggerIslandingBlackStartRequest\x12\x86\x01\n" +
	"\"triggerIslandingBlackStartResponse\x18\x06 \x01(\v24.teslapower.TEGAPITriggerIslandingBlackStartResponseH\x00R\"triggerIslandingBlackStartResponse\x12\x83\x01\n" +
	"!triggerAssetManifestUploadRequest\x18\a \x01(\v23.teslapower.TEGAPITriggerAssetManifestUploadRequestH\x00R!triggerAssetManifestUploadRequest\x12\x86\x01\n" +
	"\"triggerAssetManifestUploadResponse\x18\b \x01(\v24.teslapower.TEGAPITriggerAssetManifestUploadResponseH\x00R\"triggerAssetManifestUploadResponseB\t\n" +
	"\amessage\"\r\n" +
	"\vTEGSettings\"\x18\n" +
	"\x16TEGAPIGetConfigRequest\"\xe6\x02\n" +
	"\x17TEGAPIGetConfigResponse\x128\n" +
	"\bsettings\x18\x01 \x01(\v2\x17.teslapower.TEGSettingsH\x00R\bsettings\x88\x01\x01\x12;\n" +
	"\n" +
	"wifiConfig\x18\x02 \x01(\v2\x16.teslapower.WifiConfigH\x01R\n" +
	"wifiConfig\x88\x01\x01\x125\n" +
	"\x04wifi\x18\x03 \x01(\v2\x1c.teslapower.NetworkInterfaceH\x02R\x04wifi\x88\x01\x01\x123\n" +
	"\x03eth\x18\x04 \x01(\v2\x1c.teslapower.NetworkInterfaceH\x03R\x03eth\x88\x01\x01\x123\n" +
	"\x03gsm\x18\x05 \x01(\v2\x1c.teslapower.NetworkInterfaceH\x04R\x03gsm\x88\x01\x01B\v\n" +
	"\t_settingsB\r\n" +
	"\v_wifiConfigB\a\n" +
	"\x05_wifiB\x06\n" +
	"\x04_ethB\x06\n" +
	...
	"(TEGAPITriggerIslandingBlackStartResponse\"F\n" +
	"\x1aTEGAPISetIslandModeRequest\x12\x12\n" +
	"\x04mode\x18\x01 \x01(\x05R\x04mode\x12\x14\n" +
	"\x05force\x18\x02 \x01(\bR\x05force\"5\n" +
	"\x1bTEGAPISetIslandModeResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x05R\x06result\")\n" +
	"'TEGAPITriggerAssetManifestUploadRequest\"*\n" +
	"(TEGAPITriggerAssetManifestUploadResponse\"\xe5\x04\n" +
	"\x15EnergySiteNetMessages\x12Z\n" +
	"\x10addDeviceRequest\x18\x01 \x01(\v2,.teslapower.EnergySiteNetAPIAddDeviceRequestH\x00R\x10addDeviceRequest\x12]\n" +
	"\x11addDeviceResponse\x18\x02 \x01(\v2-.teslapower.EnergySiteNetAPIAddDeviceResponseH\x00R\x11addDeviceResponse\x12c\n" +
	"\x13removeDeviceRequest\x18\x03 \x01(\v2/.teslapower.EnergySiteNetAPIRemoveDeviceRequestH\x00R\x13removeDeviceRequest\x12f\n" +
	"\x14removeDeviceResponse\x18\x04 \x01(\v20.teslapower.EnergySiteNetAPIRemoveDeviceResponseH\x00R\x14removeDeviceResponse\x12Z\n" +
	"\x10getConfigRequest\x18\x05 \x01(\v2,.teslapower.EnergySiteNetAPIGetConfigRequestH\x00R\x10getConfigRequest\x12]\n" +
	"\x11getConfigResponse\x18\x06 \x01(\v2-.teslapower.EnergySiteNetAPIGetConfigResponseH\x00R\x11getConfigResponseB\t\n" +
	"\amessage\"$\n" +
	"\"LocalAuthAPIRequiredFactorsRequest\"]\n" +
	"#LocalAuthAPIRequiredFactorsResponse\x12\x1a\n" +
	"\bpassword\x18\x01 \x01(\bR\bpassword\x12\x1a\n" +
	"\bpresence\x18\x02 \x01(\bR\bpresence\"\x88\x01\n" +
	"\x18LocalAuthAPILoginRequest\x12 \n" +
	"\vParticipant\x18\x01 \x01(\x05R\vParticipant\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x124\n" +
	"\bpassword\x18\x03 \x01(\v2\x18.teslapower.WifiPasswordR\bpassword\"3\n" +
	"\x19LocalAuthAPILoginResponse\x12\x16\n" +
	...
	"#LocalAuthAPICheckAuthStatusResponse\x12\x16\n" +
	"\x06result\x18\x01 \x01(\x05R\x06result*\x97\x01\n" +
	...
	"\x15TESLA_SERVICE_COMMAND\x10\x01BMZKgithub.com/blackbirdworks/gopowerwall/powerwall/proto/teslapower;teslapowerb\x06proto3"

var (
	file_tesla_proto_rawDescOnce sync.Once
	file_tesla_proto_rawDescData []byte
)

func file_tesla_proto_rawDescGZIP() []byte {
	file_tesla_proto_rawDescOnce.Do(func() {
		file_tesla_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_tesla_proto_rawDesc), len(file_tesla_proto_rawDesc)))
	})
...
var file_tesla_proto_goTypes = []any{
...
func file_tesla_proto_init() {
	...
	file_tesla_proto_msgTypes[1].OneofWrappers = []any{
		(*Participant_Din)(nil),
		(*Participant_TeslaService)(nil),
		(*Participant_Local)(nil),
		(*Participant_AuthorizedClient)(nil),
	}
	file_tesla_proto_msgTypes[5].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[6].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[7].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[8].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[10].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[11].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[12].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[15].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[16].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[17].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[18].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[20].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[32].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[35].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[36].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[37].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[38].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[43].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[44].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[45].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[53].OneofWrappers = []any{
		(*DeviceVital_IntValue)(nil),
		(*DeviceVital_FloatValue)(nil),
		(*DeviceVital_StringValue)(nil),
		(*DeviceVital_BoolValue)(nil),
	}
	file_tesla_proto_msgTypes[59].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[60].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[61].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[65].OneofWrappers = []any{
	...
	file_tesla_proto_msgTypes[66].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[67].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[73].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[74].OneofWrappers = []any{
		(*MessageEnvelope_Common)(nil),
		(*MessageEnvelope_Teg)(nil),
		(*MessageEnvelope_Energysitenet)(nil),
	}
	file_tesla_proto_msgTypes[75].OneofWrappers = []any{
	...
	file_tesla_proto_msgTypes[76].OneofWrappers = []any{
	...
	file_tesla_proto_msgTypes[79].OneofWrappers = []any{}
	file_tesla_proto_msgTypes[86].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_tesla_proto_rawDesc), len(file_tesla_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   95,
			NumExtensions: 0,
			NumServices:   0,
