...
// an authenticated FleetAPI models.
func newAuthenticatedBackend(t *testing.T, srv *httptest.Server) *fleetapi.Client {
	t.Helper()
...
func TestFleetAPISystemStatusOverlay(t *testing.T) {
	...
	cases := []testCase{
		...
		// "fixing" it to match the cloud models. An empty siteStatus
