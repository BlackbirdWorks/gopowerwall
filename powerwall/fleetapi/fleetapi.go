...
// Client implements the Tesla FleetAPI models.
type Client struct {
...
// PyPowerwallFleetAPI is an alias for Client.
type PyPowerwallFleetAPI = Client
...
func (f *Client) Authenticate(ctx context.Context) error {
	f.mu.Lock()
	defer f.mu.Unlock()
	...
	if err != nil {
		return fmt.Errorf("%w: %s - run setup -fleetapi", models.ErrMissingAuthFile, cfgPath)
	}
...
// changes.
func (f *Client) persistToken(cfgPath string, tok *oauth2.Token) error {
...
func (f *Client) postJSON(ctx context.Context, url string, body map[string]any) error {
...
func (f *Client) Poll(ctx context.Context, api string, force, recursive, raw bool) (any, error) {
...
func (f *Client) Post(ctx context.Context, api string, payload any, _ string, _, _ bool) (any, error) {
...
func (f *Client) getSiteData(ctx context.Context, force bool) (map[string]any, error) {
	url := fmt.Sprintf("%s/api/1/energy_sites/%s/live_status", f.baseURL, f.siteID)

	return f.fetchSiteJSON(ctx, "SITE_DATA", url, force)
}

func (f *Client) getSiteConfig(ctx context.Context, force bool) (map[string]any, error) {
...
func (f *Client) getSiteBattery(ctx context.Context, force bool) (map[string]any, error) {
...
// upstream's caching for this endpoint.
func (f *Client) getBackupTimeRemaining(ctx context.Context, force bool) (map[string]any, error) {
...
func (f *Client) getAPIMetersAggregates(ctx context.Context, force bool) (any, error) {
...
func (f *Client) getAPIOperation(ctx context.Context, force bool) (any, error) {
...
func (f *Client) postAPIOperation(ctx context.Context, payload any, _ string, _, _ bool) (any, error) {
...
func (f *Client) postBackupReserve(ctx context.Context, fields map[string]any, errs *[]error) bool {
...
func (f *Client) postOperationMode(ctx context.Context, fields map[string]any, errs *[]error) bool {
...
func (f *Client) getAPISiteInfo(ctx context.Context, force bool) (any, error) {
	cfg, _ := f.getSiteConfig(ctx, force)
	siteName := "Powerwall"
...
func (f *Client) getAPISiteInfoSiteName(ctx context.Context, force bool) (any, error) {
	return f.getAPISiteInfo(ctx, force)
}

func (f *Client) getAPIStatus(ctx context.Context, force bool) (any, error) {
	cfg, _ := f.getSiteConfig(ctx, force)
	din := f.siteID
...
// site_info) to succeed and returns [models.ErrNotFound] - upstream's None
...
func (f *Client) getAPISystemStatus(ctx context.Context, force bool) (any, error) {
...
func (f *Client) getAPISystemStatusGridStatus(ctx context.Context, force bool) (any, error) {
	data, _ := f.getSiteData(ctx, force)
...
func (f *Client) getAPISystemStatusSOE(ctx context.Context, force bool) (any, error) {
	data, _ := f.getSiteData(ctx, force)
	pct := 100.0
	if data != nil {
...
func (f *Client) Vitals(_ context.Context) (map[string]any, error) {
	return map[string]any{}, nil
}
...
func (f *Client) GetTimeRemaining(ctx context.Context) (*float64, error) {
...
func (f *Client) Power(ctx context.Context) (map[string]float64, error) {
...
func (f *Client) FetchPower(ctx context.Context, sensor string, verbose bool) (any, error) {
	if verbose {
		payload, err := f.Poll(ctx, "/api/meters/aggregates", false, false, false)
		if err != nil {
			return nil, err
...
func (f *Client) SetGridCharging(ctx context.Context, mode bool) (map[string]any, error) {
...
func (f *Client) GetGridCharging(ctx context.Context) (*bool, error) {
...
func (f *Client) SetGridExport(ctx context.Context, mode string) (map[string]any, error) {
...
func (f *Client) GetGridExport(ctx context.Context) (*string, error) {
	cfg, err := f.getSiteConfig(ctx, false)
	if err != nil {
		return nil, err
	}
...
func (f *Client) GetSiteInfo(ctx context.Context, force ...bool) (any, error) {
	forced := false
	if len(force) > 0 {
		forced = force[0]
	}
...
func (f *Client) GetLiveStatus(ctx context.Context, force ...bool) (any, error) {
	forced := false
	if len(force) > 0 {
		forced = force[0]
	}
