...
import (
	...
	tedapipb "github.com/blackbirdworks/gopowerwall/powerwall/proto/tedapi"
...
func TestBackendAuthenticate(t *testing.T) {
	...
	t.Run("failure returns ErrLogin", func(t *testing.T) {
		...
		require.ErrorIs(t, p.Authenticate(t.Context()), models.ErrLogin)
	})
}
...
func TestBackendGoOffGridAndReconnectGrid(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			useV1r:    false,
			wantErr:   true,
			wantErrIs: models.ErrUnsupported,
		},
		{
